...
// TODO test hook to make sure the refresh feature works.
// TODO add loading
...
const useFetchRefresh = () => {
    ...
    const fetchRefresh = async (url: string, method: string, headers?: Record<string, any>, body?: Record<string, any> | HTMLFormElement) => {
        let newBody;
        ...
        if (response.status === 401) {
            ...
            login(parsedRefresh.accessToken);
